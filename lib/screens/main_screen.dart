          ...
          child: BottomNavigationBar(
            ...
            items: [
              BottomNavigationBarItem(
                icon: Image.asset('images/icon_home_not_active.png'),
                activeIcon: Image.asset('images/icon_home_active.png'),
                label: 'Item1',
              ),
              BottomNavigationBarItem(
                icon: Image.asset('images/icon_search_not_active.png'),
                activeIcon:
                    Image.asset('images/icon_search_navigation_active.png'),
                label: 'Item2',
              ),
              BottomNavigationBarItem(
                icon: Image.asset('images/icon_add_not_active.png'),
                activeIcon: Image.asset('images/icon_add_active.png'),
                label: 'Item3',
              ),
              BottomNavigationBarItem(
                icon: Image.asset('images/icon_heart_not_active.png'),
                activeIcon: Image.asset('images/icon_heart_active.png'),
                label: 'Item4',
              ),
              BottomNavigationBarItem(
                icon: Container(
